...
public class LibraryImporterImpl extends ReporterAdapter implements Library.Importer {
	...
	public Revision fetch() throws Exception {
		...
		revision.modified = revision.insertDate;
		...
		if (program == null) {
			...
			program.modified = revision.modified;
